...
# SCORING WORKFLOW - VITAMIN E WORKFLOW6
...
if __name__ == '__main__':
    ...
    if enabled_1:
        ...
        ligands_info = p.get_labeled_names("Vitamin_E_6.sdf", ">=", 1000)
    ...
    if enabled_2:
        ...
        comp_train.plot("Vitamin E - W6: Actives vs. Inactives - Training Set", filename = "results/vite_6ncf_results_comparison_train.jpg")
        comp_train.plot("Vitamin E - W6: Actives vs. Inactives - Training Set", filename = "results/vite_6ncf_results_comparison_train.png")
        comp_val.plot("Vitamin E - W6: Actives vs. Inactives - Validation Set", filename = "results/vite_6ncf_results_comparison_val.jpg")
        comp_val.plot("Vitamin E - W6: Actives vs. Inactives - Validation Set", filename = "results/vite_6ncf_results_comparison_val.png")
        comp_test.plot("Vitamin E - W6: Actives vs. Inactives - Test Set", filename = "results/vite_6ncf_results_comparison_test.jpg")
        comp_test.plot("Vitamin E - W6: Actives vs. Inactives - Test Set", filename = "results/vite_6ncf_results_comparison_test.png")
